...
config: Dict[str, Any] = {
    ...
    "category_aliases": {  # aliases for categories
        ...
        "amphibole group": ["amphibole", "amphiboles"],
        "feldspar - plagioclase": ["plagioclase", "plagioclases"],
        "feldspar - potassium": ["potassium", "k-feldspar"],
        "garnet group": ["garnet", "garnets"],
        "mica group": ["mica", "micas"],
        "pyroxene group": ["pyroxene", "pyroxenes"],
        "quartz varieties": ["quartz", "quartzes"],
        "coal varieties": ["coal", "coals"],
        "schist varieties": ["schist", "schists"],
        "limestone varieties": ["limestone", "limestones"],
        "sandstone varieties": ["sandstone", "sandstones"],
    },
